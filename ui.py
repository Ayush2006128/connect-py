...
def draw_menu(screen, font_path):
    ...
    pygame.draw.circle(screen, BLUE, (WIDTH // 2 - 150, 280), 20)
    pygame.draw.circle(screen, YELLOW, (WIDTH // 2 + 150, 280), 20)
    ...
    pygame.draw.circle(screen, BLUE, (WIDTH // 2 - 150, 380), 20)
    pygame.draw.circle(screen, ORANGE, (WIDTH // 2 + 150, 380), 20)
    # Robot face on AI circle
    pygame.draw.circle(screen, BLACK, (WIDTH // 2 + 145, 377), 4)  # Left eye
    pygame.draw.circle(screen, BLACK, (WIDTH // 2 + 155, 377), 4)  # Right eye
    pygame.draw.line(
        screen, BLACK, (WIDTH // 2 + 143, 386), (WIDTH // 2 + 157, 386), 2
    )  # Mouth
